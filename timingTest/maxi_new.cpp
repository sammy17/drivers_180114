...
long long unsigned int totalTime_hw = 0;
long long unsigned int totalTime_sw = 0;
...
int main(int argc, char *argv[]) {
    ...
    cap0.set(CV_CAP_PROP_CONVERT_RGB,true);
...
//    auto begin = std::chrono::high_resolution_clock::now();
    ...
    // printf("Elapsed time total   : %lld us\n",std::chrono::duration_cast<std::chrono::microseconds>(end-begin).count());
        ...
        totalTime_hw += std::chrono::duration_cast<std::chrono::microseconds>(end3-begin2).count();
